...
const upsertTrainerProfileValidation = z.object({
  body: z.object({
    ...
    certifications: z.array(
      ...
      }).strict() // Rejects unknown fields within the certification object
    ).optional(),
  }).strict() // Rejects unknown fields in the root body
});

export const TrainerProfileValidations = {
  upsertTrainerProfileValidation,
};
